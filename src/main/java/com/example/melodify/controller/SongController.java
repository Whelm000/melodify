...
import com.example.melodify.pojo.Song;
import com.example.melodify.service.SongService;
...
@RestController
@RequestMapping("/song")
@Tag(name = "歌曲管理", description = "歌曲管理相关接口")
public class SongController {
     ...
     * 根据歌曲id查询歌曲对象
     */
    @Operation(summary = "根据歌曲id查询歌曲对象")
    @GetMapping("/detail")
     ...
     * 根据歌手名字精确查询歌曲
     */
    @Operation(summary = "根据歌手名字精确查询歌曲")
     ...
     * 根据歌手名字模糊查询歌曲
     */
    @Operation(summary = "根据歌手名字模糊查询歌曲")
