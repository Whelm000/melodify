...
import com.example.melodify.pojo.SongList;
import com.example.melodify.service.SongListService;
...
@Tag(name = "歌单", description = "歌单相关接口")
public class SongListController {
     ...
     * 根据标题精确查询歌单列表
     */
    @Operation(summary = "根据标题精确查询歌单列表")
     ...
     * 根据标题模糊查询歌单列表
     */
    @Operation(summary = "根据标题模糊查询歌单列表")
     ...
     * 根据风格模糊查询歌单列表
     */
    @Operation(summary = "根据风格模糊查询歌单列表")
