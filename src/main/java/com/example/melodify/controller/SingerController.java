...
import com.example.melodify.pojo.Singer;
import com.example.melodify.service.SingerService;
...
@Tag(name = "歌手", description = "歌手相关接口")
public class SingerController {
     ...
     * 根据歌手名字模糊查询列表
     */
    @Operation(summary = "根据歌手名字模糊查询列表")
