...
import com.example.melodify.pojo.Consumer;
import com.example.melodify.service.ConsumerService;
import com.example.melodify.utils.Consts;
import com.example.melodify.utils.PathUtils;
...
@Tag(name = "用户", description = "前端用户相关操作")
public class ConsumerController {
     ...
     * 添加前端用户
     */
    @Operation(summary = "注册、添加前端用户", description = "注册新的前端用户")
    @PostMapping("/add")
     ...
     * 修改前端用户
     */
    @Operation(summary = "修改前端用户", description = "根据用户 ID 修改前端用户信息")
    @PostMapping("/update")
     ...
     * 删除前端用户
     */
    @Operation(summary = "删除前端用户", description = "根据用户 ID 删除前端用户")
    @GetMapping("/delete")
     ...
     * 根据主键查询整个对象
     */
    @Operation(summary = "根据主键查询整个对象", description = "根据用户 ID 查询前端用户信息")
     ...
     * 查询所有前端用户
     */
    @Operation(summary = "查询所有前端用户", description = "查询系统中所有的前端用户")
     ...
     * 更新前端用户图片
     */
    @Operation(summary = "更新前端用户图片", description = "根据用户 ID 更新前端用户的头像图片")
    ...
    public Object updateConsumerPic(@RequestParam("file") MultipartFile avatorFile, @RequestParam("id") int id) {
        ...
        // 存储到数据库里的相对文件地址
        String storeAvatarPath = "/userImages/" + fileName;
        try {
     ...
     * 前端用户登录
     */
    @Operation(summary = "前端用户登录", description = "前端用户使用用户名和密码进行登录")
    @PostMapping("/login")
